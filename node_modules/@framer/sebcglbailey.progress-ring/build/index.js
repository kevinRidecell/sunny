...
eval("var map = {\n\t\"./Progress_Ring.tsx\": \"./code/Progress_Ring.tsx\"\n};\n\n\nfunction webpackContext(req) {\n\tvar id = webpackContextResolve(req);\n\tvar module = __webpack_require__(id);\n\treturn module;\n}\nfunction webpackContextResolve(req) {\n\tvar id = map[req];\n\tif(!(id + 1)) { // check for number or string\n\t\tvar e = new Error('Cannot find module \"' + req + '\".');\n\t\te.code = 'MODULE_NOT_FOUND';\n\t\tthrow e;\n\t}\n\treturn id;\n}\nwebpackContext.keys = function webpackContextKeys() {\n\treturn Object.keys(map);\n};\nwebpackContext.resolve = webpackContextResolve;\nmodule.exports = webpackContext;\nwebpackContext.id = \"./code sync recursive \\\\.(t|j)s(x?)|\\\\.css$\";//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./code sync recursive \\.(t|j)s(x?)|\\.css$\n");

/***/ }),

/***/ "./code/Progress_Ring.tsx":
/*!********************************!*\
  !*** ./code/Progress_Ring.tsx ***!
  \********************************/
/*! no static exports found */
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst React = __webpack_require__(/*! react */ \"react\");\nconst framer_1 = __webpack_require__(/*! framer */ \"framer\");\nconst svgStyle = {\n    position: \"absolute\",\n    transform: \"rotate(-90deg)\",\n    overflow: \"visible\"\n};\nclass ProgressRing extends React.Component {\n    constructor() {\n        super(...arguments);\n        this.state = {\n            value: 370,\n            margin: 8,\n            color: \"#ffffff\",\n            stroke: 2,\n            round: false\n        };\n    }\n    componentDidMount() {\n        window[\"__checkBudget__\"]();\n        const { value, margin } = this.props;\n        this.setState({ value, margin });\n    }\n    componentWillReceiveProps(props) {\n        window[\"__checkBudget__\"]();\n        let { value, margin, color, stroke, round } = this.props;\n        if (props.value !== value) {\n            value = props.value;\n        }\n        if (props.margin !== margin) {\n            margin = props.margin;\n        }\n        if (props.color !== color) {\n            color = props.color;\n        }\n        if (props.stroke !== stroke) {\n            stroke = props.stroke;\n        }\n        if (props.round !== round) {\n            round = props.round;\n        }\n        this.setState({ value, margin, color, stroke, round });\n    }\n    render() {\n        window[\"__checkBudget__\"]();\n        const { width, height } = this.props;\n        const { value, margin, color, stroke, round } = this.state;\n        const circ = Math.PI * (width - margin * 2);\n        const dashArray = circ;\n        const dashOffset = circ - (value / 100) * circ;\n        return (React.createElement(framer_1.Frame, { width: width, height: height, background: null },\n            React.createElement(\"svg\", { style: Object.assign({}, svgStyle), width: width, height: height },\n                React.createElement(\"circle\", { cx: width / 2, cy: height / 2, r: width / 2 - margin, \"stroke-width\": stroke, stroke: `${color}`, strokeDasharray: circ, strokeDashoffset: dashOffset, strokeLinecap: round ? \"round\" : null, fill: \"none\" }))));\n    }\n}\nProgressRing.defaultProps = {\n    width: 300,\n    height: 300,\n    color: \"#ffffff\",\n    value: 50,\n    margin: 8,\n    stroke: 2,\n    round: false\n};\nProgressRing.propertyControls = {\n    round: { type: framer_1.ControlType.Boolean, title: \"Rounded\" },\n    stroke: { type: framer_1.ControlType.Number, title: \"Width\" },\n    value: { type: framer_1.ControlType.Number, title: \"Value\" },\n    margin: { type: framer_1.ControlType.Number, title: \"Margin\" },\n    color: { type: framer_1.ControlType.Color, title: \"Color\" }\n};\nexports.ProgressRing = ProgressRing;\nexports.__info__ = [{ name: \"ProgressRing\", children: false, type: \"component\" }];\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./code/Progress_Ring.tsx\n");
...
eval("module.exports = {\"main\":\"build/index.js\",\"license\":\"MIT\",\"devDependencies\":{\"@types/react\":\"^16.0.31\",\"framer\":\"^0.1.27\"},\"peerDependencies\":{\"framer\":\"^0.1.27\",\"react\":\"^16.3.0\",\"react-dom\":\"^16.3.0\"},\"framer\":{\"id\":\"e50ac1da-97c7-4748-b4e6-539dcb50e312\",\"displayName\":\"Progress Ring\"},\"author\":\"Sebastian Bailey\",\"name\":\"@framer/sebcglbailey.progress-ring\",\"version\":\"1.0.0\"};//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIuL3BhY2thZ2UuanNvbi5qcyIsInNvdXJjZVJvb3QiOiIifQ==\n//# sourceURL=webpack-internal:///./package.json\n");
